var valoresParaRealizarArcoTangente = ["30", "15"];
var total = 0;
for (var g = 0; g < valoresParaRealizarArcoTangente.length; g++) {
    if (valoresParaRealizarArcoTangente[g] == "") {
        total = total + 0;
    }
    else {
        total = total + parseFloat(valoresParaRealizarArcoTangente[g]);
        console.log("Valor para realizar o arco tangente: ", total);
    }
}
...
var resultado22 = Math.atan(total);
console.log("Resultado do Arco Tangente: ", resultado22);
