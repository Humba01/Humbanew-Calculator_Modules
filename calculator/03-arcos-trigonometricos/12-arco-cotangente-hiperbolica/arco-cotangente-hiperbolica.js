var valoresParaRealizarArcoCotangenteHiperbolica = ["30", "15"];
var total = 0;
for (var g = 0; g < valoresParaRealizarArcoCotangenteHiperbolica.length; g++) {
...
var resultado30 = 1 / Math.atanh(total);
