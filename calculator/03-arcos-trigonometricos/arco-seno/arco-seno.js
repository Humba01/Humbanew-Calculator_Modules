var valoresParaRealizarArcoSeno = ["2", "1", "1000000000000000"];
var total = 0;
for (var g = 0; g < valoresParaRealizarArcoSeno.length; g++) {
    if (valoresParaRealizarArcoSeno[g] == "") {
        total = total + 0;
    }
    else {
        total = total + parseFloat(valoresParaRealizarArcoSeno[g]);
        console.log("Valor para realizar o arco seno: ", total);
    }
}
...
var resultado20 = Math.asin(total);
console.log("Resultado do Arco Seno: ", resultado20);
