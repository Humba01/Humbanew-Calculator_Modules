const valoresParaRealizarArcoSenoHiperbolico: string[] = ["30", "15"];

var total = 0;

for(let g = 0; g < valoresParaRealizarArcoSenoHiperbolico.length; g++) {
  if(valoresParaRealizarArcoSenoHiperbolico[g] == "") {
      total = total + 0;
  } else {
    total = total + parseFloat(valoresParaRealizarArcoSenoHiperbolico[g]);
    console.log("Valor para realizar o arco seno hiperbólico: ", total);
  }
}
...
let resultado26 = Math.asinh(total);
console.log("Resultado do Arco Seno Hiperbólico: ", resultado26);