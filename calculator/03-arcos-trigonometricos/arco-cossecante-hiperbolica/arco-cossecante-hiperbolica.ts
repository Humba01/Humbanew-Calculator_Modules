const valoresParaRealizarArcoCossecanteHiperbolica: string[] = ["30", "15"];

var total = 0;

for(let g = 0; g < valoresParaRealizarArcoCossecanteHiperbolica.length; g++) {
...
let resultado31 = 1 / Math.asinh(total);
