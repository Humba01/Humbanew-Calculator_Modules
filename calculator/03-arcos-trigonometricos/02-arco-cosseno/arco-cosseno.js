var valoresParaRealizarArcoCosseno = ["30", "15"];
var total = 0;
for (var g = 0; g < valoresParaRealizarArcoCosseno.length; g++) {
    if (valoresParaRealizarArcoCosseno[g] == "") {
        total = total + 0;
    }
    else {
        total = total + parseFloat(valoresParaRealizarArcoCosseno[g]);
        console.log("Valor para realizar o arco cosseno: ", total);
    }
}
...
var resultado21 = Math.acos(total);
console.log("Resultado do Arco Cosseno: ", resultado21);
