var valoresParaRealizarArcoCotangente = ["30", "15"];
var total = 0;
for (var g = 0; g < valoresParaRealizarArcoCotangente.length; g++) {
    if (valoresParaRealizarArcoCotangente[g] == "") {
        total = total + 0;
    }
    else {
        total = total + parseFloat(valoresParaRealizarArcoCotangente[g]);
        console.log("Valor para realizar o arco cotangente: ", total);
    }
}
...
var resultado25 = 1 / Math.atan(total);
console.log("Resultado do Arco Cotangente: ", resultado25);
