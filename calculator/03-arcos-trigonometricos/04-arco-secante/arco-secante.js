var valoresParaRealizarArcoSecante = ["30", "15"];
var total = 0;
for (var g = 0; g < valoresParaRealizarArcoSecante.length; g++) {
    if (valoresParaRealizarArcoSecante[g] == "") {
        total = total + 0;
    }
    else {
        total = total + parseFloat(valoresParaRealizarArcoSecante[g]);
        console.log("Valor para realizar o arco secante: ", total);
    }
}
...
var resultado23 = 1 / Math.acos(total);
console.log("Resultado do Arco Secante: ", resultado23);
